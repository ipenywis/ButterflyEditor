...
> {
  ...
  applyPickedColor() {
    ...
    //Make style ready
    const style: ICreateStyle["styles"] = {
      color: colorText
        ? `rgba(${color.r}, ${color.g}, ${color.b}, ${opacityValue})`
        : null,
  ...
  render() {
    ...
    /*
    <div className="type" onMouseDown={e => e.preventDefault()}>
              <label
              ...
              >
                <input
                  type="checkbox"
                  checked={this.state.colorBackground}
                  onChange={e => {
                    //e.preventDefault();
                    this.setState(prevState => ({
                      colorText: !prevState.colorText
                    }));
                  }}
                />
